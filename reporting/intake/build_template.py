...
changes:
  ...
  1. Rebranded TwentySix -> Zigbert. The intake is for the Zigbert product;
     TwentySix is the consultancy behind it.
...
OUT = Path(__file__).parent / "Zigbert-Benchmarking-Template.xlsx"
ROWS = 500

# Brand tokens from zigbert-waitlist/zigbertdesign.md. openpyxl wants ARGB.
INK = "FF121C2B"
CLAY = "FFC9785A"
CLAY_TINT = "FFE8D8CE"
WASH = "FFF6F7F9"
